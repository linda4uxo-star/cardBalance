                    ...
                    <div className={`${styles.sectionCard} ${styles.steam}`}>
                        <div className={styles.sectionIcon}>
                            <svg width="60" height="60" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M11.979 0C5.678 0 .511 4.86.022 11.037l6.432 2.658c.545-.371 1.203-.59 1.912-.59.063 0 .125.004.188.006l2.861-4.142V8.91c0-2.495 2.028-4.524 4.524-4.524 2.494 0 4.524 2.031 4.524 4.527s-2.03 4.525-4.524 4.525h-.105l-4.076 2.911c0 .052.004.105.004.159 0 1.875-1.515 3.396-3.39 3.396-1.635 0-3.02-1.173-3.328-2.721L.332 15.111A12.136 12.136 0 0 0 12.021 24c6.627 0 12-5.373 12-12s-5.373-12-12-12zm7.625 15.129a2.495 2.495 0 0 1-2.5 2.498 2.495 2.495 0 0 1-2.5-2.498 2.495 2.495 0 0 1 2.5-2.498 2.495 2.495 0 0 1 2.5 2.498zm-.417 0a2.078 2.078 0 0 0-2.083-2.083 2.078 2.078 0 0 0-2.084 2.083 2.078 2.078 0 0 0 2.084 2.083 2.078 2.078 0 0 0 2.083-2.083zm-7.625 4.671a1.087 1.087 0 0 1-1.083-1.087c0-.6.485-1.087 1.083-1.087s1.083.487 1.083 1.087a1.087 1.087 0 0 1-1.083 1.087z" />
                            </svg>
                        </div>
                        <h2>Steam</h2>
