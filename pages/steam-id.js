...
export default function SteamIdPage() {
    ...
    <div className={styles.steamPage}>
      ...
      <main className={styles.main}>
        <div className={styles.breadcrumb}>
          Support › Steam Wallet › Check Issuance ID
        </div>
                ...
                <div className={styles.result}>
                  ...
                  {result.message ? (
                    ...
                    <>
                      ...
                      <button type="button" className={styles.button} onClick={copyIssuanceId} style={{ marginTop: '15px', background: 'transparent', border: '1px solid #4ade80' }}>
