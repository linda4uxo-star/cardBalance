        ...
        <section className={styles.cardSection} style={{ padding: 0, margin: 0, position: 'relative' }}>
          ...
          <div className={styles.formContainer}>
            ...
            <div className={styles.tutorialWrapper} style={{ marginTop: '16px', borderTop: 'none', paddingTop: 0 }}>
              ...
              >
                <span>How do I check my Razer Gold Arcade card?</span>
                <svg
                  viewBox="0 0 24 24"
                  width="20"
                  height="20"
              ...
              <div className={`${styles.tutorialContent} ${showIssuanceInfo ? styles.show : ''}`}>
                <div className={styles.tutorialStep}>
                  <div className={styles.stepNumber}>1</div>
                  <div className={styles.stepText}>Enter your Razer Gold Gift Card code in the field above. The code is usually 16 digits (e.g., XXXX-XXXX-XXXX-XXXX) found on the back of a physical card or in a digital purchase email.</div>
                </div>
                <div className={styles.tutorialStep}>
                  <div className={styles.stepNumber}>2</div>
                  <div className={styles.stepText}>Click "Check ID" and wait for the result. Your code will be verified to confirm compatibility with Razer Gold Arcade.</div>
                </div>
                <div className={styles.tutorialStep}>
                  <div className={styles.stepNumber}>3</div>
