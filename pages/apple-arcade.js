...
export default function AppleArcadePage() {
  ...
  return (
    <div className={styles.appleStyles}>
      ...
      <main className="page-root" style={{ paddingTop: 0, background: '#f6f6fb', minHeight: '100vh' }}>
        <div className="shell" style={{ padding: '0 22px' }}>
          <section className="hero" style={{ marginBottom: 0 }}>
            ...
            <p className="hero-text" style={{ marginTop: 0, marginBottom: '40px' }}>Enter your 16 digit code to check if your card is Apple Arcade compatible.</p>
          </section>
